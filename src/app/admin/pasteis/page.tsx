    ...
    <div className="space-y-6 sm:space-y-8">
      <div className="text-center space-y-3 sm:space-y-4">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-vegOrange to-vegYellow text-background rounded-lg sm:rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 font-bold text-sm sm:text-base"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {pasteis.map((pastel) => (
          <div
            key={pastel.id}
            className="group bg-gradient-to-br from-pastel to-background rounded-xl sm:rounded-2xl border-2 border-vegOrange/20 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden"
          >
