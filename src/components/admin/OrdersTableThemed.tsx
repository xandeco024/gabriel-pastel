        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gradient-to-r from-vegGreen/10 to-vegYellow/10 border-b-2 border-vegGreen/20">
              <th className="px-6 py-4 text-left text-sm font-holtwood text-vegBrown-dark uppercase tracking-wider">
                Pedido
              </th>
              <th className="px-6 py-4 text-left text-sm font-holtwood text-vegBrown-dark uppercase tracking-wider">
                Cliente
          ...
          <tbody className="divide-y divide-vegGreen/10">
            {orders.map((order) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  <span className="text-xl font-bold text-vegGreen">
                ...
                <td className="px-6 py-4">
                  <select
                    ...
                    className={`px-4 py-2 text-sm font-semibold rounded-xl border-2 cursor-pointer transition-all duration-200 hover:scale-105 ${statusColors[order.status as keyof typeof statusColors]}`}
                  >
                ...
                <td className="px-6 py-4">
                  <span className="text-sm text-vegBrown-light font-semibold">
                ...
                <td className="px-6 py-4">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-vegGreen/10 hover:bg-vegGreen text-vegGreen hover:text-background rounded-xl transition-all duration-200 hover:scale-105 font-semibold border-2 border-vegGreen/20 hover:border-vegGreen"
                  >
